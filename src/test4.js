...
// console.log(spriteRect.get(app.stage.children[2]))
...
function onDragMove(evt) {
  if (this.dragging) {
    const rect = spriteRect.get(this)
    const test = {...rect}
    console.log(evt.data.global.x, test.x)
    test.x = test.x + (evt.data.global.x - lastX)
